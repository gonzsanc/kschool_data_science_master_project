...
filterStream(file.name = "job_offers_EN_01.json", # Save tweets in a json file
             track = c("job","jobs","job offer","jobs offer","vacant position","vacant positions",
                       ...
                       ,"chemist","biologist","astronomer","historian","archeologist","economist","philosopher","psychologist"
                       ...
                       ,"bus driver","truck driver","car mechanic","firefighter","librarian","farmer","tailor","model","politician"
                       ,"priest","travel agent","hairdresser","hairstylist","barber","beautician","cosmetologist","cleaning lady"
