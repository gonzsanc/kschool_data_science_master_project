...
#The tweets vector is converted into a corpus containing all the messages.
...
#Print in stdout those terms that are repeated at least 5000 times across the corpus.
